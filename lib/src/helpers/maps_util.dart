...
class MapsUtil {
  ...
  Future<dynamic> get(String url) {
    return http.get((BASE_URL + url)as Uri).then((http.Response response) {
...
//      print("API Response: " + res);
  ...
  Future<String> getAddressName(LatLng location, String apiKey) async {
    try {
      ...
      var response = jsonDecode((await http.get(endPoint as Uri, headers: await LocationUtils.getAppHeaders())).body);
